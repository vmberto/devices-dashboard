...
export { StartIndexComponent } from './start/start-index.component';
export { LoginComponent } from './start/login/login.component';
export { RegisterComponent } from './start/register/register.component';
...
export { ClientsIndexComponent } from './pages/clients/clients-index.component';

export { ClientsListComponent } from './pages/clients/clients-list/clients-list.component';
